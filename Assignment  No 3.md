1. Why are functions advantageous to have in your programs?Functions reduces the need for duplicate code. This makes programs shorter, easier to read, and easier to update.
